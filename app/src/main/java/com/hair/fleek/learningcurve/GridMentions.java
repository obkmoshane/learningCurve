...
import data.TextLinkClickListener;
 ...
 */
public class GridMentions extends AppCompatActivity implements QueryTokenReceiver,
        SuggestionsResultListener, SuggestionsVisibilityManager, TextLinkClickListener {
    ...
    {
        Toast.makeText(this,"Clicked: " + clickedString.toString(),Toast.LENGTH_SHORT).show();
    }
