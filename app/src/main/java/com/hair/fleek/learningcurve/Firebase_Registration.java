...
import com.hair.fleek.helper.Constants;
import com.hair.fleek.helper.NotificationListener;

import java.util.HashMap;
import java.util.Map;

public class Firebase_Registration extends AppCompatActivity {
    EditText editTextEmail;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_firebase__registration);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!isRegistered()) {
                    ...
                    //displaying a toast
                    Toast.makeText(Firebase_Registration.this, "Already registered...", Toast.LENGTH_SHORT).show();
                }
            }
        });
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        if (response.trim().equalsIgnoreCase("success")) {
                            ...
                            Toast.makeText(Firebase_Registration.this, "Registered successfully", Toast.LENGTH_SHORT).show();
                            ...
                            Toast.makeText(Firebase_Registration.this, "Choose a different email", Toast.LENGTH_SHORT).show();
                        }
                    }
                },
