...
public class SuggestionsAdapterTest {
    ...
    public void testAddSuggestions() throws Exception {
        ...
        // Add another TestMention with different keyword, ensure com.hair.fleek.learningcurve.adapter only has second test mention
        TestMention testMention2 = new TestMention("Second Name");
        addMentionToEditor(testMention2, "Second", "Group");
        assertEquals(1, mAdapter.getCount());

        // Add another TestMention with same keyword, ensure that com.hair.fleek.learningcurve.adapter has both mentions
