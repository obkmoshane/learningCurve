...
public interface SuggestionsListBuilder {
     ...
     * @param context     current {@link android.content.Context} within the com.hair.fleek.learningcurve.adapter
     * @param inflater    {@link android.view.LayoutInflater} to use
     * @param resources   {@link android.content.res.Resources} to use
     *
     * @return a view for the corresponding {@link Suggestible} object in the com.hair.fleek.learningcurve.adapter
     */
    @NonNull
