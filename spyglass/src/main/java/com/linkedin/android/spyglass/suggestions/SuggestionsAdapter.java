...
public class SuggestionsAdapter extends BaseAdapter {
    ...
    /**
     * Method to notify the com.hair.fleek.learningcurve.adapter that a new {@link QueryToken} has been received and that
     * suggestions will be added to the com.hair.fleek.learningcurve.adapter once generated.
     *
    ...
    /**
     * Add mention suggestions to a given bucket in the com.hair.fleek.learningcurve.adapter. The com.hair.fleek.learningcurve.adapter tracks the latest result for every given
    ...
    public void addSuggestions(final @NonNull SuggestionsResult result,
        ...
        synchronized (mLock) {
            ...
            // If we have suggestions, add them to the com.hair.fleek.learningcurve.adapter and display them
    ...
    /**
     * Clear all data from com.hair.fleek.learningcurve.adapter.
     */
    public void clear() {
        mResultMap.clear();
        notifyDataSetChanged();
    ...
    /**
     * Determines if the com.hair.fleek.learningcurve.adapter is still waiting for results for a given {@link QueryToken}
     *
